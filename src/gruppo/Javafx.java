...
class GameControls extends HBox {
  GameControls(final GameManager gameManager, final Game game) {
    ...
    Button changeBackground = new Button("Change color");
    changeBackground.getStyleClass().add("play-again");
    changeBackground.setDefaultButton(true);
...
class SquareSkin extends StackPane {
  static final Image noughtImage = new Image(
      "https://icons.iconarchive.com/icons/dooffy/characters/128/O2-icon.png"
  );
  static final Image crossImage = new Image(
      "https://icons.iconarchive.com/icons/dooffy/characters/128/X1-icon.png"
  );
